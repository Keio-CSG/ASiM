...
cfg.asim_vit_attn_nrow = 256 # CiM column length (number of row-parallelism)
...
cfg.asim_vit_mlp_nrow = 256 # CiM column length (number of row-parallelism)
...
cfg.asim_vit_fc_nrow = 256 # CiM column length (number of row-parallelism)
...
cfg.pretrain_model_path = r'E:\Machine_Learning\ASiM_Model_Lib\resnet18_cifar10_w8a8_pact_trim_100.pkl'
