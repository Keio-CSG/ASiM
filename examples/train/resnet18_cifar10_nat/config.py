...
cfg.asim_conv_mode = 'Train' # Mode: Train/Inference/Simulation
...
cfg.asim_conv_trim_noise = 50.0 # Noise intensity for noise-aware training or evaluate inference accuracy

# <|Specify the settings for ASiMLinear layers|>
cfg.asim_linear_mode = 'Train' # Mode: Train/Inference/Simulation
...
cfg.asim_linear_trim_noise = 50.0 # Noise intensity for noise-aware training or evaluate inference accuracy
...
cfg.asim_vit_attn_qk_kbit = 8 # Key bit in QK computation
...
cfg.asim_vit_attn_proj_xbit = 8 # Activation bit in WX/WO projection
...
cfg.asim_vit_attn_mode = 'Train' # Mode: Train/Inference/Simulation
...
cfg.asim_vit_mlp_mode = 'Train' # Mode: Train/Inference/Simulation
...
cfg.asim_vit_fc_mode = 'Train' # Mode: Train/Inference/Simulation
...
cfg.pretrain_model_path = r'D:\Machine_Learning\ASiM_Models\resnet18_cifar10_w8a8_pact_trim_100.pkl'
...
cfg.max_epoch = 80 # Training = 200, Fine-Tune = 80
cfg.lr_init = 0.001 # SGD Training = 0.01, SGD Fine-Tune = 0.001, Adam Training = 1e-4, Adam Fine-Tune = 1e-5
